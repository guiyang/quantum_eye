...
import QEChartAlertTrend from "../Charts/QE-ChartAlertTrend";
import QEDataStats from "../DataStats/QE-DataStats";
import TopChannels from "../TopChannels";
import QETopRiskUsersChart from "../TopChart/QE-TopRiskUsersChart";
import QETopSensitiveDataAccess from "../TopChart/QE-TopSensitiveDataAccess";
import TopBusinessAppsAccess from "../TopChart/QE-TopBusinessAppsAccess";
      ...
      <div className="grid grid-cols-12 gap-4 md:gap-6 2xl:gap-7.5">
        ...
        <div className="col-span-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 2xl:gap-7.5">
            ...
            <div className="col-span-1">
              <QETopSensitiveDataAccess />
            </div>
            <div className="col-span-1">
              <TopBusinessAppsAccess />
            </div>
          </div>
        </div>
